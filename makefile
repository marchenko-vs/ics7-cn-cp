...
server.out : $(OBJ_DIR) $(OBJ_DIR)/main.o $(OBJ_DIR)/logger.o $(OBJ_DIR)/parser.o
	$(CC) $(OBJ_DIR)/*.o -o server.out

$(OBJ_DIR) :
	@mkdir -p $(OBJ_DIR)

$(OBJ_DIR)/main.o : $(SRC_DIR)/main.c $(INC_DIR)/logger.h $(INC_DIR)/parser.h
...
$(OBJ_DIR)/parser.o : $(SRC_DIR)/parser.c $(INC_DIR)/parser.h
	$(CC) $(CFLAGS) -I $(INC_DIR) $(SRC_DIR)/parser.c -c -o $(OBJ_DIR)/parser.o
